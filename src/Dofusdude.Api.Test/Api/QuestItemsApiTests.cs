...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class QuestItemsApiTests : IDisposable
    {
        ...
        public void GetAllItemsQuestListTest()
        {
            ...
            //var response = instance.GetAllItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding);
        ...
        public void GetItemsQuestListTest()
        {
            ...
            //var response = instance.GetItemsQuestList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem);
            //Assert.IsType<ItemsListPaged>(response);
        }
        ...
        public void GetItemsQuestSearchTest()
        {
            ...
            //int? filterMaxLevel = null;
            //int? limit = null;
            //var response = instance.GetItemsQuestSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit);
