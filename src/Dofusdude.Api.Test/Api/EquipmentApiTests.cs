...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class EquipmentApiTests : IDisposable
    {
        ...
        public void GetItemsEquipmentListTest()
        {
            ...
            //var response = instance.GetItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem);
            //Assert.IsType<ItemsListPaged>(response);
        }
        ...
        public void GetItemsEquipmentSearchTest()
        {
            ...
            //int? filterMaxLevel = null;
            //int? limit = null;
            //var response = instance.GetItemsEquipmentSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit);
