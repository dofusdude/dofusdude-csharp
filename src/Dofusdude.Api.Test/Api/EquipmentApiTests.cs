...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class EquipmentApiTests : IDisposable
    {
        ...
        public void GetAllItemsEquipmentListTest()
        {
            ...
            //var response = instance.GetAllItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum);
        ...
        public void GetItemsEquipmentListTest()
        {
            ...
            //List<string>? filterTypeEnum = null;
            //var response = instance.GetItemsEquipmentList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum);
            //Assert.IsType<ItemsListPaged>(response);
        }
        ...
        public void GetItemsEquipmentSearchTest()
        {
            ...
            //int? limit = null;
            //List<string>? filterTypeEnum = null;
            //var response = instance.GetItemsEquipmentSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum);
