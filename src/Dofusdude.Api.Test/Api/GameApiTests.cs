...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class GameApiTests : IDisposable
    {
        ...
        public void GetGameSearchTest()
        {
            ...
            //var response = instance.GetGameSearch(language, game, query, filterType, limit, fieldsItem, filterTypeEnum);
            //Assert.IsType<List<GetGameSearch200ResponseInner>>(response);
        }
        ...
        public void GetItemsAllSearchTest()
        {
            ...
            //int? limit = null;
            //List<string>? filterTypeEnum = null;
            //var response = instance.GetItemsAllSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum);
            //Assert.IsType<List<ItemsListEntryTyped>>(response);
        }
    }
}
