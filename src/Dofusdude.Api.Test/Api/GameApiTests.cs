...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class GameApiTests : IDisposable
    {
        ...
        public void GetGameSearchTest()
        {
            ...
            //var response = instance.GetGameSearch(language, game, query, filterType, limit, fieldsItem);
        ...
        public void GetItemsAllSearchTest()
        {
            ...
            //int? limit = null;
            //var response = instance.GetItemsAllSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit);
