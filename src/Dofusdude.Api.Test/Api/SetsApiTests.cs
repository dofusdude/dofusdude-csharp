...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class SetsApiTests : IDisposable
    {
        ...
        public void GetAllSetsListTest()
        {
            ...
            //var response = instance.GetAllSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, acceptEncoding, filterIsCosmetic);
        ...
        public void GetSetsListTest()
        {
            ...
            //bool? filterIsCosmetic = null;
            //var response = instance.GetSetsList(language, game, sortLevel, filterMinHighestEquipmentLevel, filterMaxHighestEquipmentLevel, pageSize, pageNumber, fieldsSet, filterIsCosmetic);
            //Assert.IsType<SetsListPaged>(response);
        }
