...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class CosmeticsApiTests : IDisposable
    {
        ...
        public void GetAllCosmeticsListTest()
        {
            ...
            //var response = instance.GetAllCosmeticsList(language, game, sortLevel, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeNameId);
        ...
        public void GetCosmeticsListTest()
        {
            ...
            //List<string>? filterTypeNameId = null;
            //var response = instance.GetCosmeticsList(language, game, sortLevel, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeNameId);
            //Assert.IsType<ListItems>(response);
        }
        ...
        public void GetCosmeticsSearchTest()
        {
            ...
            //int? limit = null;
            //List<string>? filterTypeNameId = null;
            //var response = instance.GetCosmeticsSearch(language, game, query, filterMinLevel, filterMaxLevel, limit, filterTypeNameId);
