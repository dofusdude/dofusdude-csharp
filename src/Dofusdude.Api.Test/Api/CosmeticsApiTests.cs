...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class CosmeticsApiTests : IDisposable
    {
        ...
        public void GetCosmeticsListTest()
        {
            ...
            //var response = instance.GetCosmeticsList(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem);
            //Assert.IsType<ItemsListPaged>(response);
        }
        ...
        public void GetCosmeticsSearchTest()
        {
            ...
            //int? filterMaxLevel = null;
            //int? limit = null;
            //var response = instance.GetCosmeticsSearch(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit);
