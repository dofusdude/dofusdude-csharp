...
namespace Dofusdude.Api.Test.Api
{
    ...
    public class MountsApiTests : IDisposable
    {
        ...
        public void GetAllMountsListTest()
        {
            ...
            //var response = instance.GetAllMountsList(language, game, filterFamilyName, acceptEncoding);
            //Assert.IsType<MountsListPaged>(response);
        }
        ...
        public void GetMountsListTest()
        {
            ...
            //var response = instance.GetMountsList(language, game, filterFamilyName, pageSize, pageNumber, fieldsMount);
            //Assert.IsType<MountsListPaged>(response);
        }
        ...
        public void GetMountsSearchTest()
        {
            ...
            //Assert.IsType<List<MountListEntry>>(response);
        }
