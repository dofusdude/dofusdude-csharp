...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Condition : IValidatableObject
    {
        ...
        public Condition(string varOperator = default(string), int intValue = default(int), TranslatedId element = default(TranslatedId))
        {
        ...
        public TranslatedId Element { get; set; }
