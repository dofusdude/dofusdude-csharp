...
namespace Dofusdude.Api.Model
{
    ...
    /// SetEffectsEntry
    /// </summary>
    [DataContract(Name = "Set-Effects-Entry")]
    public partial class SetEffectsEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetEffectsEntry" /> class.
        /// </summary>
        ...
        /// <param name="itemCombination">how many items it needs to trigger this effect with the given set.</param>
        public SetEffectsEntry(int intMinimum = default(int), int intMaximum = default(int), SetEffectsEntryType type = default(SetEffectsEntryType), bool ignoreIntMin = default(bool), bool ignoreIntMax = default(bool), string formatted = default(string), int itemCombination = default(int))
        {
        ...
        /// </summary>
        /// <value>how many items it needs to trigger this effect with the given set</value>
        [DataMember(Name = "item_combination", EmitDefaultValue = false)]
        public int ItemCombination { get; set; }
