...
namespace Dofusdude.Api.Model
{
    ...
    /// Cosmetic
    /// </summary>
    [DataContract(Name = "Cosmetic")]
    public partial class Cosmetic : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Cosmetic" /> class.
        /// </summary>
        ...
        public Cosmetic(int ankamaId = default(int), string name = default(string), string description = default(string), CosmeticType type = default(CosmeticType), int level = default(int), int pods = default(int), ImageUrls imageUrls = default(ImageUrls), List<EffectsEntry> effects = default(List<EffectsEntry>), List<ConditionEntry> conditions = default(List<ConditionEntry>), ConditionTreeNode conditionTree = default(ConditionTreeNode), List<RecipeEntry> recipe = default(List<RecipeEntry>))
        {
