...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Resource : IValidatableObject
    {
        ...
        public Resource(int ankamaId = default(int), string name = default(string), string description = default(string), ResourceType type = default(ResourceType), int level = default(int), int pods = default(int), ImageUrls imageUrls = default(ImageUrls), List<EffectsEntry> effects = default(List<EffectsEntry>), List<ConditionEntry> conditions = default(List<ConditionEntry>), ConditionTreeNode conditionTree = default(ConditionTreeNode), List<RecipeEntry> recipe = default(List<RecipeEntry>))
        {
