...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Resource : IValidatableObject
    {
        ...
        public Resource(int ankamaId = default(int), string name = default(string), string description = default(string), TranslatedId type = default(TranslatedId), int level = default(int), int pods = default(int), Images imageUrls = default(Images), List<Effect> effects = default(List<Effect>), ConditionNode conditions = default(ConditionNode), List<Recipe> recipe = default(List<Recipe>))
        {
