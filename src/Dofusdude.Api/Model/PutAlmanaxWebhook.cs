...
namespace Dofusdude.Api.Model
{
    ...
    public partial class PutAlmanaxWebhook : IValidatableObject
    {
        ...
        */
        ...
        /// </summary>
        /// <param name="bonusWhitelist">from all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses. Delete old entries with empty array []. Just null changes nothing..</param>
        /// <param name="bonusBlacklist">from all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses. Delete old entries with empty array []. Just null changes nothing..</param>
        ...
        /// </summary>
        /// <value>from all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses. Delete old entries with empty array []. Just null changes nothing.</value>
