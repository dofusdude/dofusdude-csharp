...
namespace Dofusdude.Api.Model
{
    ...
    /// MountListEntry
    /// </summary>
    [DataContract(Name = "Mount-List-Entry")]
    public partial class MountListEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MountListEntry" /> class.
        /// </summary>
        ...
        public MountListEntry(int ankamaId = default(int), string name = default(string), string familyName = default(string), ImageUrls imageUrls = default(ImageUrls), List<EffectsEntry> effects = default(List<EffectsEntry>))
        {
