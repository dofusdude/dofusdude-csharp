...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Weapon : IValidatableObject
    {
        ...
        public Weapon(int ankamaId = default(int), string name = default(string), string description = default(string), ItemsListEntryTypedType type = default(ItemsListEntryTypedType), bool isWeapon = default(bool), int level = default(int), int pods = default(int), ImageUrls imageUrls = default(ImageUrls), List<EffectsEntry> effects = default(List<EffectsEntry>), List<ConditionEntry> conditions = default(List<ConditionEntry>), ConditionTreeNode conditionTree = default(ConditionTreeNode), int criticalHitProbability = default(int), int criticalHitBonus = default(int), bool isTwoHanded = default(bool), int maxCastPerTurn = default(int), int apCost = default(int), WeaponRange range = default(WeaponRange), List<RecipeEntry> recipe = default(List<RecipeEntry>), ItemListEntryParentSet parentSet = default(ItemListEntryParentSet))
        {
        ...
        /// </summary>
        [DataMember(Name = "critical_hit_probability", EmitDefaultValue = false)]
        public int CriticalHitProbability { get; set; }

        /// <summary>
        /// Gets or Sets CriticalHitBonus
        /// </summary>
        [DataMember(Name = "critical_hit_bonus", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "max_cast_per_turn", EmitDefaultValue = false)]
        public int MaxCastPerTurn { get; set; }

        /// <summary>
        /// Gets or Sets ApCost
        /// </summary>
        [DataMember(Name = "ap_cost", EmitDefaultValue = false)]
