...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Weapon : IValidatableObject
    {
        ...
        public Weapon(int ankamaId = default(int), string name = default(string), string description = default(string), TranslatedId type = default(TranslatedId), bool isWeapon = default(bool), int level = default(int), int pods = default(int), Images imageUrls = default(Images), List<Effect> effects = default(List<Effect>), ConditionNode conditions = default(ConditionNode), int criticalHitProbability = default(int), int criticalHitBonus = default(int), int maxCastPerTurn = default(int), int apCost = default(int), Range range = default(Range), List<Recipe> recipe = default(List<Recipe>), TranslatedId parentSet = default(TranslatedId))
        {
