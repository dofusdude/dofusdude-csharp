...
namespace Dofusdude.Api.Model
{
    ...
    public partial class RssWebhook : IValidatableObject
    {
        ...
        public RssWebhook(string id = default(string), List<string> whitelist = default(List<string>), List<string> blacklist = default(List<string>), List<string> subscriptions = default(List<string>), FormatEnum? format = default(FormatEnum?), int previewLength = default(int), DateTime createdAt = default(DateTime), DateTime? lastFiredAt = default(DateTime?), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PreviewLength, must be a value less than or equal to 4000.", new [] { "PreviewLength" });
            }
