...
namespace Dofusdude.Api.Model
{
    ...
    /// LinksPaged
    /// </summary>
    [DataContract(Name = "Links-Paged")]
    public partial class LinksPaged : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksPaged" /> class.
        /// </summary>
        /// <param name="first">first.</param>
        /// <param name="prev">prev.</param>
        /// <param name="next">next.</param>
        /// <param name="last">last.</param>
        public LinksPaged(string first = default(string), string prev = default(string), string next = default(string), string last = default(string))
        {
            this.First = first;
            this.Prev = prev;
            this.Next = next;
