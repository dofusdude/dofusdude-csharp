...
namespace Dofusdude.Api.Model
{
    ...
    public partial class EquipmentSet : IValidatableObject
    {
        ...
        public EquipmentSet(int ankamaId = default(int), string name = default(string), List<int> equipmentIds = default(List<int>), List<List<SetEffectsEntry>> effects = default(List<List<SetEffectsEntry>>), int highestEquipmentLevel = default(int))
        {
