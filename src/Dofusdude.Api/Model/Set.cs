...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Set : IValidatableObject
    {
        ...
        public Set(int ankamaId = default(int), string name = default(string), List<int> equipmentIds = default(List<int>), Dictionary<string, List<Effect>> effects = default(Dictionary<string, List<Effect>>), int highestEquipmentLevel = default(int), bool isCosmetic = default(bool))
        {
