...
namespace Dofusdude.Api.Model
{
    ...
    public partial class SetListEntry : IValidatableObject
    {
        ...
        public SetListEntry(int ankamaId = default(int), string name = default(string), int items = default(int), int level = default(int), List<List<SetEffectsEntry>> effects = default(List<List<SetEffectsEntry>>), List<int> equipmentIds = default(List<int>))
        {
