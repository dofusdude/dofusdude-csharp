...
namespace Dofusdude.Api.Model
{
    ...
    /// GameSearchItem
    /// </summary>
    [DataContract(Name = "GameSearchItem")]
    public partial class GameSearchItem : IValidatableObject
    {
        ...
        public GameSearchItem(GameSearchType type = default(GameSearchType), int? level = default(int?), Images imageUrls = default(Images))
        {
            this.Type = type;
            this.Level = level;
