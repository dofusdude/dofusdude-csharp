...
namespace Dofusdude.Api.Model
{
    ...
    public partial class CreateAlmanaxWebhookDailySettings : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MidnightOffset, must be a value less than or equal to 23.", new [] { "MidnightOffset" });
            }

            // MidnightOffset (int?) minimum
            if (this.MidnightOffset < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MidnightOffset, must be a value greater than or equal to 0.", new [] { "MidnightOffset" });
            }
