...
namespace Dofusdude.Api.Model
{
    ...
    public partial class CreateAlmanaxWebhookMentionsValueInner : IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PingDaysBefore, must be a value less than or equal to 31.", new [] { "PingDaysBefore" });
            }

            // PingDaysBefore (int?) minimum
            if (this.PingDaysBefore < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PingDaysBefore, must be a value greater than or equal to 1.", new [] { "PingDaysBefore" });
            }
