...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Mount : IValidatableObject
    {
        ...
        public Mount(int ankamaId = default(int), string name = default(string), string familyName = default(string), ImageUrls imageUrls = default(ImageUrls), List<EffectsEntry> effects = default(List<EffectsEntry>))
        {
