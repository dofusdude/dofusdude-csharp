...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Mount : IValidatableObject
    {
        ...
        public Mount(int ankamaId = default(int), string name = default(string), MountFamily family = default(MountFamily), Images imageUrls = default(Images), List<Effect> effects = default(List<Effect>))
        {
        ...
        public MountFamily Family { get; set; }
