...
namespace Dofusdude.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlmanaxWebhook_daily_settings")]
    public partial class AlmanaxWebhookDailySettings : IValidatableObject
    {
        ...
        public AlmanaxWebhookDailySettings(string timezone = @"Europe/Paris", int midnightOffset = 0)
        {
        ...
        */
        ...
        <example>0</example>
        */
        [DataMember(Name = "midnight_offset", EmitDefaultValue = false)]
