...
namespace Dofusdude.Api.Model
{
    ...
    /// RecipeEntry
    /// </summary>
    [DataContract(Name = "Recipe-Entry")]
    public partial class RecipeEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipeEntry" /> class.
        /// </summary>
        /// <param name="itemAnkamaId">itemAnkamaId.</param>
        /// <param name="itemSubtype">itemSubtype.</param>
        /// <param name="quantity">quantity.</param>
        public RecipeEntry(int itemAnkamaId = default(int), string itemSubtype = default(string), int quantity = default(int))
        {
        ...
        /// </summary>
        [DataMember(Name = "item_ankama_id", EmitDefaultValue = false)]
