...
namespace Dofusdude.Api.Model
{
    ...
    public partial class Effect : IValidatableObject
    {
        ...
        public Effect(int intMinimum = default(int), int intMaximum = default(int), EffectType type = default(EffectType), bool ignoreIntMin = default(bool), bool ignoreIntMax = default(bool), string formatted = default(string))
        {
