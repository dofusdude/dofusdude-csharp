...
namespace Dofusdude.Api.Model
{
    ...
    /// PutTwitterWebhook
    /// </summary>
    [DataContract(Name = "PutTwitterWebhook")]
    public partial class PutTwitterWebhook : IValidatableObject
    {
        ...
        public PutTwitterWebhook(List<string> whitelist = default(List<string>), List<string> blacklist = default(List<string>), List<string> subscriptions = default(List<string>), int? previewLength = default(int?))
        {
