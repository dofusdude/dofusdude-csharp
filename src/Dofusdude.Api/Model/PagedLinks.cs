...
namespace Dofusdude.Api.Model
{
    ...
    public partial class PagedLinks : IValidatableObject
    {
        ...
        public PagedLinks(string first = default(string), string prev = default(string), string next = default(string), string last = default(string))
        {
            this.First = first;
            this.Prev = prev;
            this.Next = next;
