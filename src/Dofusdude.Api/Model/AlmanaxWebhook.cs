...
namespace Dofusdude.Api.Model
{
    ...
    /// AlmanaxWebhook
    /// </summary>
    [DataContract(Name = "AlmanaxWebhook")]
    public partial class AlmanaxWebhook : IValidatableObject
    {
        ...
        */
        ...
        /// <param name="bonusWhitelist">Only post when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses..</param>
        /// <param name="bonusBlacklist">Skip the day when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses.</param>
        ...
        public AlmanaxWebhook(Guid id = default(Guid), AlmanaxWebhookDailySettings dailySettings = default(AlmanaxWebhookDailySettings), List<string> bonusWhitelist = default(List<string>), List<string> bonusBlacklist = default(List<string>), List<string> subscriptions = default(List<string>), bool isoDate = false, Dictionary<string, List<CreateAlmanaxWebhookMentionsValueInner>> mentions = default(Dictionary<string, List<CreateAlmanaxWebhookMentionsValueInner>>), List<IntervalsEnum> intervals = default(List<IntervalsEnum>), WeeklyWeekdayEnum? weeklyWeekday = default(WeeklyWeekdayEnum?), DateTime createdAt = default(DateTime), DateTime? lastFiredAt = default(DateTime?), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
        ...
        /// </summary>
        [DataMember(Name = "daily_settings", EmitDefaultValue = false)]
        public AlmanaxWebhookDailySettings DailySettings { get; set; }

        /// <summary>
        /// Only post when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses.
        /// </summary>
        /// <value>Only post when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses.</value>
        ...
        /// </summary>
        /// <value>Skip the day when these bonuses come up. From all available bonuses (ids) from /dofus2/meta/{language}/almanax/bonuses</value>
        ...
        */
        ...
        public List<AlmanaxWebhook.IntervalsEnum> Intervals { get; set; }
