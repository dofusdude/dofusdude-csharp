...
namespace Dofusdude.Api.Api
{
    ...
    public interface IQuestItemsApiSync : IApiAccessor
    {
        ...
        List<ItemListEntry> GetItemsQuestSearch(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), int operationIndex = 0);
        ...
        ApiResponse<List<ItemListEntry>> GetItemsQuestSearchWithHttpInfo(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), int operationIndex = 0);
    ...
    public interface IQuestItemsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Resource> GetItemQuestSingleAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Resource>> GetItemQuestSingleWithHttpInfoAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// List Quest Items
        /// </summary>
        /// <remarks>
    ...
    public partial class QuestItemsApi : IQuestItemsApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Resource</returns>
        public async System.Threading.Tasks.Task<Resource> GetItemQuestSingleAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Resource)</returns>
        public async System.Threading.Tasks.Task<Dofusdude.Api.Client.ApiResponse<Resource>> GetItemQuestSingleWithHttpInfoAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'language' is set
            if (language == null)
            {
        ...
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = GetItemsQuestListWithHttpInfo(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem);
            return localVarResponse.Data;
        }
        ...
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = await GetItemsQuestListWithHttpInfoAsync(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ItemListEntry&gt;</returns>
        public List<ItemListEntry> GetItemsQuestSearch(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<List<ItemListEntry>> localVarResponse = GetItemsQuestSearchWithHttpInfo(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ItemListEntry&gt;</returns>
        public Dofusdude.Api.Client.ApiResponse<List<ItemListEntry>> GetItemsQuestSearchWithHttpInfo(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), int operationIndex = 0)
        {
            // verify the required parameter 'language' is set
            if (language == null)
            {
        ...
        {
            Dofusdude.Api.Client.ApiResponse<List<ItemListEntry>> localVarResponse = await GetItemsQuestSearchWithHttpInfoAsync(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
