...
namespace Dofusdude.Api.Api
{
    ...
    public interface IQuestItemsApiSync : IApiAccessor
    {
        ...
        ItemsListPaged GetAllItemsQuestList(string language, string game, string? sortLevel = default(string?), string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), string? acceptEncoding = default(string?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0);
    ...
    public partial class QuestItemsApi : IQuestItemsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ItemsListPaged</returns>
        public ItemsListPaged GetAllItemsQuestList(string language, string game, string? sortLevel = default(string?), string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), string? acceptEncoding = default(string?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = GetAllItemsQuestListWithHttpInfo(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum);
        ...
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = await GetAllItemsQuestListWithHttpInfoAsync(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
