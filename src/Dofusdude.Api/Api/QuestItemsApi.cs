...
namespace Dofusdude.Api.Api
{
    ...
    public interface IQuestItemsApiSync : IApiAccessor
    {
        ...
        List<ListItem> GetItemsQuestSearch(string language, string game, string query, int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeNameId = default(List<string>?), int operationIndex = 0);
        ...
        ApiResponse<List<ListItem>> GetItemsQuestSearchWithHttpInfo(string language, string game, string query, int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeNameId = default(List<string>?), int operationIndex = 0);
    ...
    public partial class QuestItemsApi : IQuestItemsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ListItem&gt;</returns>
        public List<ListItem> GetItemsQuestSearch(string language, string game, string query, int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeNameId = default(List<string>?), int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<List<ListItem>> localVarResponse = GetItemsQuestSearchWithHttpInfo(language, game, query, filterMinLevel, filterMaxLevel, limit, filterTypeNameId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;ListItem&gt;</returns>
        public Dofusdude.Api.Client.ApiResponse<List<ListItem>> GetItemsQuestSearchWithHttpInfo(string language, string game, string query, int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeNameId = default(List<string>?), int operationIndex = 0)
        {
            // verify the required parameter 'language' is set
            if (language == null)
            {
        ...
        {
            Dofusdude.Api.Client.ApiResponse<List<ListItem>> localVarResponse = await GetItemsQuestSearchWithHttpInfoAsync(language, game, query, filterMinLevel, filterMaxLevel, limit, filterTypeNameId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
