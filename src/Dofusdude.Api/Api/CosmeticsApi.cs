...
namespace Dofusdude.Api.Api
{
    ...
    public interface ICosmeticsApiSync : IApiAccessor
    {
        ...
        ItemsListPaged GetAllCosmeticsList(string language, string game, string? sortLevel = default(string?), string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), string? acceptEncoding = default(string?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0);
    ...
    public partial class CosmeticsApi : ICosmeticsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ItemsListPaged</returns>
        public ItemsListPaged GetAllCosmeticsList(string language, string game, string? sortLevel = default(string?), string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), string? acceptEncoding = default(string?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = GetAllCosmeticsListWithHttpInfo(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum);
        ...
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = await GetAllCosmeticsListWithHttpInfoAsync(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding, filterTypeEnum, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
