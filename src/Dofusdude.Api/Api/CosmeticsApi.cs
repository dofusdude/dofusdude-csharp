...
namespace Dofusdude.Api.Api
{
    ...
    public interface ICosmeticsApiSync : IApiAccessor
    {
        ...
        List<ItemListEntry> GetCosmeticsSearch(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0);
        ...
        ApiResponse<List<ItemListEntry>> GetCosmeticsSearchWithHttpInfo(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0);
        /// <summary>
        /// Single Cosmetics
        /// </summary>
        /// <remarks>
    ...
    public interface ICosmeticsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Cosmetic> GetCosmeticsSingleAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Cosmetic>> GetCosmeticsSingleWithHttpInfoAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class CosmeticsApi : ICosmeticsApi
    {
        ...
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = GetCosmeticsListWithHttpInfo(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum);
            return localVarResponse.Data;
        }
        ...
        {
            Dofusdude.Api.Client.ApiResponse<ItemsListPaged> localVarResponse = await GetCosmeticsListWithHttpInfoAsync(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, pageSize, pageNumber, fieldsItem, filterTypeEnum, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;ItemListEntry&gt;</returns>
        public List<ItemListEntry> GetCosmeticsSearch(string language, string game, string query, string? filterTypeName = default(string?), int? filterMinLevel = default(int?), int? filterMaxLevel = default(int?), int? limit = default(int?), List<string>? filterTypeEnum = default(List<string>?), int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<List<ItemListEntry>> localVarResponse = GetCosmeticsSearchWithHttpInfo(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum);
            return localVarResponse.Data;
        }
        ...
        {
            Dofusdude.Api.Client.ApiResponse<List<ItemListEntry>> localVarResponse = await GetCosmeticsSearchWithHttpInfoAsync(language, game, query, filterTypeName, filterMinLevel, filterMaxLevel, limit, filterTypeEnum, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Cosmetic</returns>
        public async System.Threading.Tasks.Task<Cosmetic> GetCosmeticsSingleAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Cosmetic)</returns>
        public async System.Threading.Tasks.Task<Dofusdude.Api.Client.ApiResponse<Cosmetic>> GetCosmeticsSingleWithHttpInfoAsync(string language, int ankamaId, string game, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'language' is set
            if (language == null)
            {
