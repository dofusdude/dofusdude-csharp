...
namespace Dofusdude.Api.Api
{
    ...
    public interface IMetaApiSync : IApiAccessor
    {
        ...
        ModelVersion GetMetaVersion(int operationIndex = 0);
        ...
        ApiResponse<ModelVersion> GetMetaVersionWithHttpInfo(int operationIndex = 0);
    ...
    public interface IMetaApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ModelVersion> GetMetaVersionAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ModelVersion>> GetMetaVersionWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class MetaApi : IMetaApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ModelVersion</returns>
        public ModelVersion GetMetaVersion(int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<ModelVersion> localVarResponse = GetMetaVersionWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ModelVersion</returns>
        public Dofusdude.Api.Client.ApiResponse<ModelVersion> GetMetaVersionWithHttpInfo(int operationIndex = 0)
        {
            Dofusdude.Api.Client.RequestOptions localVarRequestOptions = new Dofusdude.Api.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ModelVersion</returns>
        public async System.Threading.Tasks.Task<ModelVersion> GetMetaVersionAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Dofusdude.Api.Client.ApiResponse<ModelVersion> localVarResponse = await GetMetaVersionWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ModelVersion)</returns>
        public async System.Threading.Tasks.Task<Dofusdude.Api.Client.ApiResponse<ModelVersion>> GetMetaVersionWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
