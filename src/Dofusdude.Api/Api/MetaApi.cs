...
namespace Dofusdude.Api.Api
{
    ...
    public interface IMetaApiSync : IApiAccessor
    {
        ...
        /// <exception cref="Dofusdude.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetMetaVersion200Response</returns>
        GetMetaVersion200Response GetMetaVersion(int operationIndex = 0);
        ...
        /// <exception cref="Dofusdude.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetMetaVersion200Response</returns>
        ApiResponse<GetMetaVersion200Response> GetMetaVersionWithHttpInfo(int operationIndex = 0);
    ...
    public interface IMetaApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetMetaVersion200Response</returns>
        System.Threading.Tasks.Task<GetMetaVersion200Response> GetMetaVersionAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetMetaVersion200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<GetMetaVersion200Response>> GetMetaVersionWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class MetaApi : IMetaApi
    {
        ...
        public Dofusdude.Api.Client.ApiResponse<List<string>> GetItemTypesWithHttpInfo(int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<string>>("/dofus2/meta/items/types", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<Dofusdude.Api.Client.ApiResponse<List<string>>> GetItemTypesWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<string>>("/dofus2/meta/items/types", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetMetaVersion200Response</returns>
        public GetMetaVersion200Response GetMetaVersion(int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<GetMetaVersion200Response> localVarResponse = GetMetaVersionWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetMetaVersion200Response</returns>
        public Dofusdude.Api.Client.ApiResponse<GetMetaVersion200Response> GetMetaVersionWithHttpInfo(int operationIndex = 0)
        {
            Dofusdude.Api.Client.RequestOptions localVarRequestOptions = new Dofusdude.Api.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetMetaVersion200Response>("/dofus2/meta/version", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetMetaVersion200Response</returns>
        public async System.Threading.Tasks.Task<GetMetaVersion200Response> GetMetaVersionAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Dofusdude.Api.Client.ApiResponse<GetMetaVersion200Response> localVarResponse = await GetMetaVersionWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetMetaVersion200Response)</returns>
        public async System.Threading.Tasks.Task<Dofusdude.Api.Client.ApiResponse<GetMetaVersion200Response>> GetMetaVersionWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetMetaVersion200Response>("/dofus2/meta/version", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
