...
namespace Dofusdude.Api.Api
{
    ...
    public interface IAlmanaxApiSync : IApiAccessor
    {
        ...
        Almanax GetAlmanaxDate(string language, DateOnly date, int operationIndex = 0);
        ...
        ApiResponse<Almanax> GetAlmanaxDateWithHttpInfo(string language, DateOnly date, int operationIndex = 0);
        /// <summary>
        /// Almanax Range
        /// </summary>
        /// <remarks>
        ...
        List<Almanax> GetAlmanaxRange(string language, string? filterBonusType = default(string?), DateOnly? rangeFrom = default(DateOnly?), DateOnly? rangeTo = default(DateOnly?), int? rangeSize = default(int?), string? timezone = default(string?), int operationIndex = 0);
        ...
        ApiResponse<List<Almanax>> GetAlmanaxRangeWithHttpInfo(string language, string? filterBonusType = default(string?), DateOnly? rangeFrom = default(DateOnly?), DateOnly? rangeTo = default(DateOnly?), int? rangeSize = default(int?), string? timezone = default(string?), int operationIndex = 0);
    ...
    public interface IAlmanaxApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Almanax> GetAlmanaxDateAsync(string language, DateOnly date, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Almanax>> GetAlmanaxDateWithHttpInfoAsync(string language, DateOnly date, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        /// <summary>
        /// Almanax Range
        /// </summary>
        /// <remarks>
    ...
    public partial class AlmanaxApi : IAlmanaxApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>Almanax</returns>
        public Almanax GetAlmanaxDate(string language, DateOnly date, int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<Almanax> localVarResponse = GetAlmanaxDateWithHttpInfo(language, date);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Almanax</returns>
        public Dofusdude.Api.Client.ApiResponse<Almanax> GetAlmanaxDateWithHttpInfo(string language, DateOnly date, int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of Almanax</returns>
        public async System.Threading.Tasks.Task<Almanax> GetAlmanaxDateAsync(string language, DateOnly date, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            Dofusdude.Api.Client.ApiResponse<Almanax> localVarResponse = await GetAlmanaxDateWithHttpInfoAsync(language, date, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Almanax)</returns>
        public async System.Threading.Tasks.Task<Dofusdude.Api.Client.ApiResponse<Almanax>> GetAlmanaxDateWithHttpInfoAsync(string language, DateOnly date, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
            // verify the required parameter 'language' is set
            if (language == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;Almanax&gt;</returns>
        public List<Almanax> GetAlmanaxRange(string language, string? filterBonusType = default(string?), DateOnly? rangeFrom = default(DateOnly?), DateOnly? rangeTo = default(DateOnly?), int? rangeSize = default(int?), string? timezone = default(string?), int operationIndex = 0)
        {
            Dofusdude.Api.Client.ApiResponse<List<Almanax>> localVarResponse = GetAlmanaxRangeWithHttpInfo(language, filterBonusType, rangeFrom, rangeTo, rangeSize, timezone);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;Almanax&gt;</returns>
        public Dofusdude.Api.Client.ApiResponse<List<Almanax>> GetAlmanaxRangeWithHttpInfo(string language, string? filterBonusType = default(string?), DateOnly? rangeFrom = default(DateOnly?), DateOnly? rangeTo = default(DateOnly?), int? rangeSize = default(int?), string? timezone = default(string?), int operationIndex = 0)
        {
            // verify the required parameter 'language' is set
            if (language == null)
            {
        ...
        {
            Dofusdude.Api.Client.ApiResponse<List<Almanax>> localVarResponse = await GetAlmanaxRangeWithHttpInfoAsync(language, filterBonusType, rangeFrom, rangeTo, rangeSize, timezone, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
