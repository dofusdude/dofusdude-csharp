...
namespace Dofusdude.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.0.0-rc.3";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.0-rc.3/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.0.0-rc.3\n";
            report += "    SDK Package Version: 1.0.0-rc.3\n";
