...
namespace Dofusdude.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.0.0-rc.10";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.0.0-rc.10/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.dofusdu.de") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.0.0-rc.10\n";
            report += "    SDK Package Version: 1.0.0-rc.10\n";
