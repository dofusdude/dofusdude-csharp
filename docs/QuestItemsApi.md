...
> ItemsListPaged GetAllItemsQuestList (string language, string game, string? sortLevel = null, string? filterTypeName = null, int? filterMinLevel = null, int? filterMaxLevel = null, string? acceptEncoding = null)
...
{
    // List All Quest Items
    ApiResponse<ItemsListPaged> response = apiInstance.GetAllItemsQuestListWithHttpInfo(language, game, sortLevel, filterTypeName, filterMinLevel, filterMaxLevel, acceptEncoding);
